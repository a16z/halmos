...
@pytest.mark.parametrize('hexcode, params, output', [
    ...
    (o(EVM.ADDMOD), [x, y, con(2**3)], ZeroExt(253, Extract(2, 0, ZeroExt(8, x) + ZeroExt(8, y)))),
    (o(EVM.ADDMOD), [x, y, z], Extract(255, 0, f_mod[264](ZeroExt(8, x) + ZeroExt(8, y), ZeroExt(8, z)))),
