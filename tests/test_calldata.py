...
from halmos.calldata import DynamicArrayType, BaseType, DynamicParams
from halmos.bytevec import ByteVec
from halmos.utils import int_of, extract_bytes
...
def test_permutate_dyn_size():
    ...
    dyn_param_size.append("param1", 2, DynamicArrayType("param1", BaseType("", "uint256")))
    ...
    combinations = set((extract_size_argument(c, 0), extract_size_argument(c, 1)) for c in result)
